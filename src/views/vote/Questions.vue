<template>
  ...
  <div class="mb-10">
            ...
            <template v-for="(icon, i) in question.icons" :key="i">
              <span class="ms-1" data-bs-toggle="tooltip" :title="icon.tooltop">
                <span :class="`svg-icon svg-icon-1 ${icon.class}`">
                  <inline-svg :src="`media/${icon.path}`" />
                </span>
              </span>
            </template>
          </div>
        ...
        <div class="d-flex flex-stack flex-wrap">
          ...
          <div class="d-flex align-items-center py-1">
            ...
            <div class="symbol symbol-35px me-2">
              <img
                ...
                :src="`media/${question.avatar}`"
                alt="user"
              />
              <div
                v-else
                class="symbol-label bg-light-success fs-3 fw-bold text-success text-uppercase"
              >
                {{ question.author[0] }}
              </div>
            </div>
          ...
          <div class="d-flex align-items-center py-1">
            ...
            <template v-for="(tag, i) in question.tags" :key="i">
             ...
             Net Worth&nbsp;<b class="text-black">$675,894</b>
              </div>
            </template>
            <!--end::Tags-->
    ...
    <div class="d-flex flex-center mb-0">
      <a
        href="#"
        class="btn btn-icon btn-light btn-active-light-primary h-30px w-30px fw-bold fs-6 mx-2"
        >1</a
      >
      <a
        href="#"
        class="btn btn-icon btn-light btn-active-light-primary h-30px w-30px fw-bold fs-6 mx-2 active"
        >2</a
      >
      <a
        href="#"
